<template>
  <!-- result -->
  <v-card color="rgb(0, 0, 0, 1)" class="pa-5 ma-0" height="100%" width="100%" style="position:absolute; z-index: 20;" >
    ...
    <v-list dense  class="overflow-y-auto rounded" height="55%">
      ...
      <v-list-item-group v-else>
        ...
        >
          ...
          <!-- getter 코드로 최적화 필요 -->
          <v-list-item-content>
            <v-list-item-title>날짜 : {{h.dealYear}} 년{{  h.dealMonth }} 월 {{ h.dealDay }}일</v-list-item-title>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(mapStore,["SET_HOUSE_LIST","CLEAR_APT_LIST","SET_DETAIL_HOUSE","CLEAR_DETAIL_APT"]),
