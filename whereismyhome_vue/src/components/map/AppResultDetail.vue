<template>
  ...
  <div style="background-color: black">
    ...
    >
      <!-- 로드뷰 -->
      <v-card id="roadview" class="mb-10" style="width: 100%; height: 150px; border-radius: 25px"> </v-card>
      ...
      <v-list dense class="overflow-y-auto rounded" height="55%">
        ...
        <v-list-item-group v-else>
          <v-list-item v-for="(deal, i) in mapdata.app.result.detail.housedeals" :key="i">
            ...
            <v-list-item-content>
              <v-list-item-title
                >날짜 : {{ deal.dealYear }} 년{{ deal.dealMonth }} 월 {{ deal.dealDay }}일</v-list-item-title
              >
