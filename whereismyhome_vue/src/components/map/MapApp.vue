  ...
  methods: {
    ...
    createAllMarker(idx, position, image) {
      infra.forEach((data, idx1) => {
        data.forEach((data2, idx2) => {
          ...
          // 마커이미지와 마커를 생성합니다
          var markerImage = this.createMarkerImage(this.items[idx2].icon, imageSize, imageOptions),
    ...
    createCarparkMarkers() {
      ...
      for (var i = 0; i < carparkPositions.length; i++) {
        ...
        // 마커이미지와 마커를 생성합니다
        var markerImage = this.createMarkerImage(this.items[2].icon, imageSize, imageOptions),
    ...
    createStoreMarkers() {
      ...
      for (var i = 0; i < storePositions.length; i++) {
        ...
        // 마커이미지와 마커를 생성합니다
        var markerImage = this.createMarkerImage(this.items[1].icon, imageSize, imageOptions),
    ...
    createCoffeeMarkers() {
      ...
      for (var i = 0; i < coffeePositions.length; i++) {
        ...
        // 마커이미지와 마커를 생성합니다
        var markerImage = this.createMarkerImage(this.items[0].icon, imageSize, imageOptions),
