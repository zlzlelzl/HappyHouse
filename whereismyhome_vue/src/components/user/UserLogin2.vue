                ...
                @keyup.enter="confirm"
                  ...
                  @keyup.enter="confirm"
                      ...
                      <div class="text-center mt-16 mb-16" >
                        <v-btn type="submit" large :color="bgColor" dark @click.prevent="confirm"
                          >로그인</v-btn
                        >
                      </div>
                    </v-form>
            ...
            <v-window-item :value="2">
              <v-row class="fill-height">
                ...
                >
                  <div>
                    <v-card-text :class="`${fgColor}--text`">
                      <h1 class="text-center headline mb-3">이미 회원이신가요?
...
export default {
  ...
  created() {
    ...
    methods: {
      ...mapActions(memberStore, ["userConfirm", "getUserInfo","userRegist","userCheckId"]),
